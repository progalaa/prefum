...
@section('content')
    ...
    {!! Form::model($product, ['method' => 'PUT', 'route' => ['admin.products.update', $product->id], 'files' => true, 'enctype' =>"multipart/form-data"]) !!}

    <div class="panel panel-default">
        <div class="panel-heading">تعديل منتج</div>
                ...
                <div class="col-xs-12 form-group">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="execlusive">
                            <option value="{{$product->execlusive}}">
                                @if($product->execlusive == 1)
                                    <?php echo "نعم";?>
                                 @elseif($product->execlusive == 0)
                                    <?php echo "لا";?>
                                 @endif
                            </option>
                ...
                <div class="col-xs-12 form-group">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="category_id">
                            <option value="{{$product->category->id}}">{{ $product->category->name_ar }} -- {{ $product->category->name_en }}</option>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="menu_item_id">
                            <option value="{{$product->menu->id}}">{{ $product->menu->name_ar }} -- {{ $product->menu->name_en }}</option>
                ...
                <div class="col-xs-12 form-group">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="brand_id">
                            <option value="{{$product->brand->id}}">{{ $product->brand->name_ar }} -- {{ $product->brand->name_en }}</option>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="sub_category_id">
                            <option value="{{$product->subcat->id}}">{{ $product->subcat->name_ar }} -- {{ $product->subcat->name_en }}</option>
