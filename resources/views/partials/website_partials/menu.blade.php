                                ...
                                <div class="shop-item col-md-5th ">
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <a class="shop-item-image"
                                           href="{{route('product', [app()->getLocale(),$men->id])}}">
                                            <img class="img-responsive" src="{{ url('/public/images/'.$men->image) }}"
                                        ...
                                        <div class="shop-item-hover">
                                            <a class="btn" href="{{route('product', [app()->getLocale(),$men->id])}}">إكتشف
                                                المزيد</a>
                                        </div>
                                        <!-- /hover -->
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            @else
                                                <button id="add_cart" class="btn btn-primary btn-3d btn-reveal pull-left product-add-cart noradius"
                                                        data-user="{{ Auth::user()->id }}" data-product="{{$men->id}}"><i
                                                            class="fa fa-shopping-cart"></i>
